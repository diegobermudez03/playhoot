...
func TestEncodeDecodeJSON_MinimalDefinition(t *testing.T) {
	...
	data, err := program.EncodeJSON(original)
	if err != nil {
		t.Fatalf("EncodeJSON: %v", err)
	}
	decoded, err := program.DecodeJSON(data)
	if err != nil {
...
func TestEncodeDecodeJSON_ReEncodingStability(t *testing.T) {
	...
	firstEncode, err := program.EncodeJSON(original)
	if err != nil {
		t.Fatalf("EncodeJSON: %v", err)
	}
	decoded, err := program.DecodeJSON(firstEncode)
	if err != nil {
		t.Fatalf("DecodeJSON: %v", err)
	}
	secondEncode, err := program.EncodeJSON(*decoded)
	if err != nil {
		t.Fatalf("EncodeJSON (re-encode): %v", err)
	}
	assertGenericJSONEqual(t, firstEncode, secondEncode)

	thirdEncode, err := program.EncodeJSON(original)
	if err != nil {
...
func TestExactJSON_RootShape(t *testing.T) {
	data, err := program.EncodeJSON(buildCompleteDefinition())
	if err != nil {
		t.Fatalf("EncodeJSON: %v", err)
	}
...
func TestEncodeDecodeJSON_NilVsEmptyTopLevelSlices(t *testing.T) {
	...
	data, err := program.EncodeJSON(nilDef)
	if err != nil {
		t.Fatalf("EncodeJSON: %v", err)
	}
	var obj map[string]any
	...
	data, err = program.EncodeJSON(emptyDef)
	if err != nil {
		t.Fatalf("EncodeJSON: %v", err)
	}
	obj = nil
...
func TestDecodeJSON_TopLevelNull(t *testing.T) {
	_, err := program.DecodeJSON([]byte("null"))
	if err == nil {
		t.Fatal("expected an error")
	}
	var decodeErr *program.DecodeError
...
func TestDecodeJSON_MalformedJSON(t *testing.T) {
	_, err := program.DecodeJSON([]byte(`{"metadata":`))
	if err == nil {
		t.Fatal("expected an error")
	}
	var decodeErr *program.DecodeError
...
func TestDecodeJSON_ZeroValueDefinition(t *testing.T) {
	data, err := program.EncodeJSON(program.Definition{})
	if err != nil {
		t.Fatalf("EncodeJSON: %v", err)
	}
	var obj map[string]any
