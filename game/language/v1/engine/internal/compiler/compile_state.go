...
// Program.Types. Aliases engine.GlobalScopeRootName so the compiler and
// the runtime (a separate internal package) agree on exactly this name.
const globalScopeRootName = engine.GlobalScopeRootName
