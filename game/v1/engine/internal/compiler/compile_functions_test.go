...
func TestCompile_SimpleFunction(t *testing.T) {
	...
	v, err := runtime.Evaluate(p, fn.Body, engine.Scope{Bindings: map[string]engine.Value{"x": engine.NumberValue{Value: 21}}})
	if err != nil {
...
func TestCompile_FunctionCallsAnotherFunction(t *testing.T) {
	...
	v, err := runtime.Evaluate(p, fn.Body, engine.Scope{Bindings: map[string]engine.Value{
...
func TestCompile_BuiltinCatalog(t *testing.T) {
	...
	v, err := runtime.Evaluate(p, fn.Body, engine.Scope{Bindings: map[string]engine.Value{"x": engine.NumberValue{Value: -7}}})
	if err != nil {
		t.Fatalf("unexpected evaluation error: %v", err)
	}
...
func TestCompile_RecordAndEnumConstructionInFunction(t *testing.T) {
	...
	v, err := runtime.Evaluate(p, fn.Body, engine.Scope{Bindings: map[string]engine.Value{"pos": engine.NumberValue{Value: 9}}})
	if err != nil {
		t.Fatalf("unexpected evaluation error: %v", err)
	}
...
func TestCompile_ListQueryExpressions(t *testing.T) {
	...
	v, err := runtime.Evaluate(p, fn.Body, engine.Scope{Bindings: map[string]engine.Value{"items": items}})
	if err != nil {
		t.Fatalf("unexpected evaluation error: %v", err)
	}
