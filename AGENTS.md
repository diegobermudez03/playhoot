...
## Transitional Engineering Standards

The `Project Patterns` below remain the canonical engineering standards until
they are migrated into `docs/engineering/standards/`.

[existing Project Patterns continue unchanged]
