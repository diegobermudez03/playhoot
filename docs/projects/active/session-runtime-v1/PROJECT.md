...
Status: ACTIVE (WORK-0007 DONE; **WORK-0029 is the immediate next WORK to pick up**, human-directed 2026-09-24 - see "Current Work" below)
...
- **WORK-0029** (Session-Owned Output/Value Schema, decouple `game/session` from `engine`) - **PLANNED, and the immediate next WORK to pick up in this Project** (human-directed, 2026-09-24) - ahead of WORK-0020/WORK-0010/0011/0012, overriding this WORK's own original "wait for a real consumer" timing note. The human wants to supply design input on its own open Scope questions directly to whichever session drafts it next; that session should ask for that input before writing Approved Design, not decide those questions alone. See the WORK's own file for the open questions.
