...
- **WORK-0003** - `docs/work/active/WORK-0003-session-start-first-runtimeturn.md` - Slice 2, Start + First RuntimeTurn. Status: **READY** (created DRAFT 2026-09-19; moved READY 2026-09-19 after the human resolved all four Blockers - see its Blockers section and `HUMAN_REVIEW.md`). Implementation has not begun.
